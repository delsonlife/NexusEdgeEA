...
input group "=== V4.1 - Opportunity Pipeline ==="
input int InpOpportunityMaxAgeBars = 3; // V4.1-P3 - Nombre de bougies avant expiration d'une Opportunity
input int InpVirtualTradeMaxAgeBars = 24; // V4.1-P3.1bis - Timeout (en bougies) d'un trade virtuel jamais touché par SL/TP
//+------------------------------------------------------------------+
